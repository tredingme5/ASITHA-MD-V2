...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=niZgHCpZ#gBmxHzUQAntXjTaAvqjFbMwOpexQES-IH8JFSwyP7Qc' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hello , Ashila-MD is alive now!!*" : process.env.ALIVE_MSG,
